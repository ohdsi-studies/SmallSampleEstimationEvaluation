compare_ease_all <- function(baseFolder) {
  ...
  compareEase <- function(sampleSize) {
    ...
    cmFolder <- file.path(baseFolder, sprintf("smallSample%d", sampleSize))
  ...
  readr::write_csv(easeP, file.path(baseFolder, "easeP.csv"))
}
